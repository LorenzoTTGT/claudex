...
main() {
  ...
  printf 'Backup ID: %s\n' "$BACKUP_ID"
  printf 'Default model: gpt-5.6-sol (low effort)\n'
  printf 'Default effort: low\n'
  printf 'Installed agents: GPT-5.6 Sol low coordinator (Terra alias), GPT-5.6 Sol low Implementer, Luna high data/research, Frontend implementer, Sol advisory, Sol Review gate\n'
