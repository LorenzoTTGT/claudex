...
main() {
  ...
  printf 'Installed agents: GPT-5.6 Sol low coordinator (Terra alias), GPT-5.6 Sol low Implementer, Luna data/research, Frontend implementer, Sol advisory, Sol Review gate\n'
